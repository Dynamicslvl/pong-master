...
public class MenuController : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        {
            rect[2].GetChild(0).GetChild(0).GetComponent<RectTransform>().DOAnchorPosX(-125, 3f).SetLoops(-1, LoopType.Yoyo).SetEase(Ease.InOutSine);
    ...
    private void Update()
    {
        starNum = (int)((starClaim.anchoredPosition.x + 200) / 200f * GameManager.starMax);
        levelNum = (int)((levelComplete.anchoredPosition.x + 200) / 200f * GameManager.levelMax);
